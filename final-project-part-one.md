...
I came across articles on the potential in [entrepreneurship as a major driver of local economic growth and development](https://www.nlc.org/article/2025/05/01/how-cities-can-spark-economic-transformation-through-entrepreneur-led-economic-development/) and realised that a focus on entrepreneurship could be the new frontier for development. Growth driven by local industry. The problem is, for startups and businesses to be formed and grow to a level that can be impactful, there needs to be financing. Financing for research and development, financing to hire more and expand. Financing to develop prototypes and products.

Venture Capital is one of many financing methods for startups and the main focus of my project. I am particularly interested in VC trends in Africa. Where is financing going? What is being financed and how much VC funding is flowing into Africa compared to the rest of the world.
...
![Tier](Tier.jpg)
# The data
My data primarily comes from Statista. For cases where the statista data available is outdated, I will be retrieving more up-to-date data directly from the source highlighted in statista submissions.
...
I do not anticipate needing to combine these datasets as each tells a different part of my story. I will use this data to generate  the separate visualizations that form the whole story. 


# Method and medium
I anticipate using Shorthand, tableau and possibly canva to visualize my data. Canva will particularly be used for pictograms while shorthand will be used as the platform on which my story lives and tableau the main visualization tool. 
